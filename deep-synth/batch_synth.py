...
parser.add_argument('--temperature-pixel', type=float,
                    default=0.4, metavar='N')
...
parser.add_argument('--model-dir', type=str,
                    default="train/bedroom", metavar='S')
parser.add_argument('--continue-epoch', type=int, default=50, metavar='N')
parser.add_argument('--location-epoch', type=int, default=100, metavar='N')
parser.add_argument('--rotation-epoch', type=int, default=100, metavar='N')
...
s = SceneSynth(args.location_epoch, args.rotation_epoch,
               args.continue_epoch, args.data_dir, args.model_dir)
s.synth(range(args.start, args.end), trials=args.trials,
